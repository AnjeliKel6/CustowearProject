...
class AdminController extends Controller
{
    ...
    public function users_store(Request $request)
    {
        ...
        if ($user->utype === 'ADM') {
            return redirect()->route('admin.index')->with('status', 'Admin account created successfully!');
        } elseif ($user->utype === 'USR') {
            return redirect()->route('user.index')->with('status', 'User account created successfully!');
        } elseif ($user->utype === 'VND') {
            return redirect()->route('supplier.index')->with('status', 'Vendor account created successfully!');
        }

        // Fallback jika ada kesalahan
        return redirect()->route('admin.users')->with('status', 'New account has been added successfully!');
    }
