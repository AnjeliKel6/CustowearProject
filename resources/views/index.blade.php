                                                ...
                                                <div class="product-card__price d-flex">
                                                    <span class="money price text-secondary">
                                                        @if ($sproduct->sale_price)
                                                            <s>Rp{{ number_format($sproduct->regular_price, 2) }} </s>
                                                            Rp{{ number_format($sproduct->sale_price, 2) }}
                                                        @else
                                                            Rp{{ number_format($sproduct->regular_price, 2) }}
                                                        @endif
                                                    </span>
                                                </div>
                                            </div>
                                ...
                                <div class="product-card__price d-flex align-items-center">
                                    <span class="money price text-secondary">
                                        @if ($fproduct->sale_price)
                                            <s>Rp{{ number_format($fproduct->regular_price, 2) }} </s>
                                            Rp{{ number_format($fproduct->sale_price, 2) }}
                                        @else
                                            Rp{{ number_format($fproduct->regular_price, 2) }}
                                        @endif
                                    </span>
                                </div>
