...
<head>
    ...
    <title>{{ config('CustoWear', 'CustoWear') }}</title>
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('supplier.material.add') }}" class="">
                                                <div class="text">Add Material</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ route('supplier.materials') }}" class="">
                                                <div class="text">Materials</div>
                                            </a>
                                        </li>
                                    </ul>
                ...
                <div class="section-content-right">
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 CustoWear</div>
                        </div>
                    </div>
