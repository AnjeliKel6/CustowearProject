        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.product.store') }}">
            ...
            <div class="wg-box">
                <fieldset class="name">
                    ...
                    @error('name') <span class="alert alert-danger text-center"></span>
                        {{ $message }}
                    @enderror
                <fieldset class="name">
                    ...
                    @error('slug') <span class="alert alert-danger text-center"></span>
                        {{ $message }}
                    @enderror
                <div class="gap22 cols">
                    <fieldset class="category">
                        ...
                        @error('category_id') <span class="alert alert-danger text-center"></span>
                            {{ $message }}
                        @enderror
                    ...
                    <fieldset class="brand">
                        ...
                        @error('brand_id') <span class="alert alert-danger text-center"></span>
                            {{ $message }}
                        @enderror
                </div>
                ...
                <fieldset class="shortdescription">
                    ...
                    <div class="text-tiny">Do not exceed 100 characters when entering the product name.</div>
                        ...
                        @error('short_description') <span class="alert alert-danger text-center"></span>
                            {{ $message }}
                        @enderror
                ...
                <fieldset class="description">
                    ...
                    <div class="text-tiny">Do not exceed 100 characters when entering the product name.</div>
                        ...
                        @error('description') <span class="alert alert-danger text-center"></span>
                            {{ $message }}
                        @enderror
            </div>
            <div class="wg-box">
                ...
                <fieldset>
                    ...
                    <div class="upload-image mb-16">
                        ...
                        @error('images') <span class="alert alert-danger text-center"></span>
                            {{ $message }}
                        @enderror
                ...
                <div class="cols gap22">
                    <fieldset class="name">
                        ...
                        @error('regular_price') <span class="alert alert-danger text-center"></span>
                            {{ $message }}
                        @enderror
                    ...
                    <fieldset class="name">
                        ...
                        @error('sale_price') <span class="alert alert-danger text-center"></span>
                            {{ $message }}
                        @enderror
                </div>
                ...
                <div class="cols gap22">
                    <fieldset class="name">
                        ...
                        @error('SKU') <span class="alert alert-danger text-center"></span>
                            {{ $message }}
                        @enderror
                    ...
                    <fieldset class="name">
                        ...
                        @error('quantity') <span class="alert alert-danger text-center"></span>
                            {{ $message }}
                        @enderror
                </div>
                ...
                <div class="cols gap22">
                    <fieldset class="name">
                        ...
                        @error('stock_status') <span class="alert alert-danger text-center"></span>
                            {{ $message }}
                        @enderror
                    <fieldset class="name">
                        ...
                        @error('featured') <span class="alert alert-danger text-center"></span>
                            {{ $message }}
                        @enderror
                </div>
