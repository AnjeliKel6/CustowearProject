...
<main class="pt-90">
    <div class="mb-4 pb-4"></div>
        ...
        <div class="shopping-cart" style="display: flex; align-items: flex-start;">
            @if($items->count()>0)
                <!-- Wrapper Tabel Cart -->
                <div class="cart-table__wrapper" style="flex: 2;">
                    <table class="cart-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="shopping-cart__product-price">Rp{{ number_format($item->price, 2, '.', '') }}</span>
                                </td>
                                <td>
                ...
                <!-- Wrapper Cart Totals -->
                <div class="shopping-cart__totals-wrapper" style="flex: 1; margin-left: 20px;">
                        ...
                        <div class="shopping-cart__totals">
                            ...
                            <table class="cart-totals">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Discoount {{Session::get('coupon')['code']}}</th>
                                    ...
                                    <tr>
                                        <th>VAT</th>
                                        <td>Rp{{ Cart::instance('discounts')->tax() }}</td>
                                    </tr>
                                    <tr>
                                        <th>Total</th>
                                        <td>Rp{{ Cart::instance('discounts')->total() }}</td>
                                    </tr>
                                </tbody>
                            </table>
                            @else
